...
@section('content')
        ...
        <div class="col-lg-4 col-md-4 order-1">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card" style="min-height: 11em;">
                        <div class="card-body">
                ...
                <div class="col-lg-6 col-md-12 col-6 mb-4">
                    <div class="card" style="min-height: 11em;">
                        <div class="card-body">
                            ...
                            <h3 class="card-title text-nowrap mb-1">{{ count($transaction_today) }}</h3>
                ...
                <div class="col-6 mb-4">
                    <div class="card" style="min-height: 11em;">
                        <div class="card-body">
                            ...
                            <span class="fw-semibold d-block mb-1"> Total Gate Parking</span>
                            <h3 class="card-title text-nowrap mb-2">{{ count($site_gate_parking) }}</h3>
                ...
                <div class="col-6 mb-4 d-none">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <span class="fw-semibold d-block mb-1">Jumlah PNS</span>
                            <h3 class="card-title mb-2">qweqwew</h3>
            ...
            <div class="card h-100">
                <div class="card-header d-flex align-items-center justify-content-between pb-0">
                    <div class="card-title mb-0">
                        <h5 class="m-0 me-2">Jumlah Pegawai</h5>
                        ...
                        <li class="d-flex mb-4 pb-1">
                            ...
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                ...
                                <div class="user-progress">
                                    <small class="fw-semibold" id="pegawai_laki_laki"></small>
                                </div>
                            </div>
                        </li>
                        <li class="d-flex mb-4 pb-1">
                            <div class="avatar flex-shrink-0 me-3">
                                <span class="avatar-initial rounded bg-label-success"><i
                                        class="fa-solid fa-person-dress"></i></span>
                            </div>
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                                ...
                                <div class="user-progress">
                                    <small class="fw-semibold" id="pegawai_perempuan"></small>
                                </div>
                            </div>
                        </li>
                        {{-- <li class="d-flex mb-4 pb-1">
    ...
    <script>
        $(document).ready(function() {
            var pegawai_laki_laki = $("#pegawai_laki_laki").text();
            var pegawai_perempuan = $("#pegawai_perempuan").text();

            const ctx = document.getElementById('chart_gender');
            ...
            const data = {
                ...
                datasets: [{
                    data: [pegawai_laki_laki, pegawai_perempuan],
                    backgroundColor: [
                        'rgb(104,108,255)',
                        'rgb(113,221,55)',
                    ],
