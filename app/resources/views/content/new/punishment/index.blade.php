...
@section('content')
    ...
    @endif
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Denda</span></h4>

    <div class="my-3">
        <div class="row d-flex justify-content-end text-end">
            <span>
                <a href="/dashboard/punishment/create">
                                    ...
                                    <td>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <a href="/dashboard/punishment/edit/{{ encrypt($item->id) }}"
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        type: "POST",
                        url: "/dashboard/punishment/delete/" + $(this)
                            .attr("attr-id"),
                        // data: data,
                        dataType: "json",
