...
@section('content')
    ...
    @endif
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Transaksi Voucher</span></h4>

    <div class="my-3">
        <div class="row d-flex justify-content-end text-end">
            <span>
                <form action="/dashboard/transaction/voucher">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="btn-group">
                                <a href="/dashboard/exportExcel/transaksi/Voucher">
                            ...
                            <a href="{{ route('dashboard/transaction/voucher') }}">
