...
@section('content')
    ...
    @endif
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Member</span></h4>
                        ...
                        <tbody>
                            @foreach ($member as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->Biaya_Ganti_Plat_Number }}</td>
                                    <td>
                                        @if ($item->Status == 1)
                                            Aktif
                                        @else
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col-4">
                                                <a href="/dashboard/member/edit/{{ encrypt($item->id) }}"
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        type: "POST",
                        url: "/dashboard/member/delete/" + $(this)
                            .attr("attr-id"),
                        // data: data,
                        dataType: "json",
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        type: "POST",
                        url: "/dashboard/member/changeStatus/" + $(".memberActivation")
                            .attr("attr-id"),
                        // data: data,
                        dataType: "json",
                        success: function(response) {
