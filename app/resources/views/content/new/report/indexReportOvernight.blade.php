...
@section('content')
    ...
    @endif
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Laporan Kendaraan Overnight</span></h4>

    <div class="my-3">
        <div class="row d-flex justify-content-end text-end">
            <span>
                <form action="/dashboard/report/overnight">
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <a href="{{ route('dashboard/report/overnight') }}">
