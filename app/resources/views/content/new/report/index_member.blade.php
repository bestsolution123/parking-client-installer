...
@section('content')
    ...
    @endif
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Laporan Member</span></h4>
    ...
    <!-- report transaction Member -->
    <div class="my-3">
        <div class="row d-flex justify-content-end text-start">
            <span class="fs-3 fw-bold">Laporan Transaksi Member</span>
        </div>
    ...
    <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Data Laporan Transaction Member</h5>
                </div>
                <div class="card-body">
                    <table id="myTable_4" class="display">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Pintu Masuk</th>
