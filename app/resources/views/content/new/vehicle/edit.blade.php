        ...
        <div class="col-xl">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="/dashboard/vehicle/edit/{{ encrypt($vehicle->id) }} "
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control selectpicker d-block border" name="vehicle_initial_id"
                                ...
                                <option value="{{ $vehicle_initial[$i]->id }}"
                                    {{ $vehicle_initial[$i]->id == $vehicle->vehicle_initial->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="basic-default-fullname"
                                placeholder="Tipe Kendaraan" name="name" value="{{ $vehicle->name }}" />
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="dengan-rupiah" placeholder="Harga Jam Ke 1"
                                name="time_price_1" value="{{ $vehicle->time_price_1 }}" />
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="dengan-rupiah-2" placeholder="Harga Jam Ke 2"
                                name="time_price_2" value="{{ $vehicle->time_price_2 }}" />
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="dengan-rupiah-3" placeholder="Harga Jam Ke 3"
                                name="time_price_3" value="{{ $vehicle->time_price_3 }}" />
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="dengan-rupiah-4"
                                placeholder="Harga Sebelum Jam Ke 1" name="grace_time"
                                value="{{ $vehicle->grace_time }}" />
                        </div>
                        <div class="mb-3">
                            ...
                            <div class="input-group mb-3">
                                <input type="number" class="form-control" id="basic-default-fullname"
                                    ...
                                    value="{{ $vehicle->grace_time_duration }}" max="60" />
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group mb-3">
                                <input type="number" class="form-control" id="basic-default-fullname"
                                    ...
                                    value="{{ $vehicle->limitation_time_duration }}" max="60" />
                                <span class="input-group-text" id="basic-addon2">Menit</span>
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" id="maximum_daily"
                                    name="maximum_daily" {{ $vehicle->maximum_daily == 1 ? 'checked' : '' }}>Checklis
                                Untuk
                                Mengaktifkan Fitur Batas Maximal
                                Harian</label>
                            </div>
                        </div>
                        <div class="mb-3" id="batas_maximal_prices"
                            style=" {{ $vehicle->maximum_daily == 0 ? 'display:none' : '' }}">
                            ...
                            <input type="text" class="form-control" placeholder="Batas Maksimal Harga Per / Hari "
                                name="maximum_daily_price" value="{{ $vehicle->maximum_daily_price }}"
                                id="dengan-rupiah-5" />
                        </div>
